...
int main() {
    ...
    ofstream matches_count_file;
    matches_count_file.open(dir+"matches_count_file.txt");

    ofstream inliers_count_file;
    inliers_count_file.open(dir+"inliers_count_file.txt");
